...
SEGMENT_GP_KEY = {IMPORT_CSV_MODEL_KEY: SegmentGrandParent,
                  ...
                  IMPORT_CSV_FIELDLIST_KEY: {
                      SegmentGrandParent.segment_grand_parent_long_name.field_name: 'Segment Grand Parent Long Name',
                      # noqa: E501
...
ESTIMATE_ROW_KEY = {IMPORT_CSV_MODEL_KEY: EstimateRow,
                    ...
                    IMPORT_CSV_FIELDLIST_KEY: {
                        EstimateRow.estimate_row_long_name.field_name: 'Estimates Row Long Name'}}  # noqa: E501
...
import_SS_class = ImportInfo(SUB_SEGMENT_KEY, 'OSCAR Sub-Segments',
