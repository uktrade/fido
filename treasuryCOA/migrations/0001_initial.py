    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_l1', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='treasuryCOA.L1Account', verbose_name='account l1 code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_l2', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='treasuryCOA.L2Account', verbose_name='account l2 code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_l3', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='treasuryCOA.L3Account', verbose_name='account l3 code')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usage_code', models.CharField(blank=True, choices=[('BOTH', 'BOTH'), ('OUTTURN', 'OUTTURN'), ('PLANS', 'PLANS')], default='BOTH', max_length=25, verbose_name='usage code')),
                ('cash_indicator_code', models.CharField(blank=True, max_length=5, verbose_name='cash indicator code')),
                ('account_l4', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='treasuryCOA.L4Account', verbose_name='account l4 code')),
            ],
            options={
