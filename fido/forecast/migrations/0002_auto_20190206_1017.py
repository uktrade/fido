    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('financial_year', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='forecast.FinancialYear')),
                ...
                ('project_code', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='chartofaccountDIT.ProjectCode')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='budget',
            name='financial_year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='forecast.FinancialYear'),
        ),
        migrations.AddField(
            model_name='budget',
        ...
        migrations.AddField(
            model_name='budget',
            name='project_code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='chartofaccountDIT.ProjectCode'),
        ),
        ...
        migrations.AlterUniqueTogether(
            name='budget',
            unique_together={('programme', 'cost_centre', 'natural_account_code', 'analysis1_code', 'analysis2_code', 'project_code', 'financial_year')},
        ),
    ]
