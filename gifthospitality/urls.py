...
from .views import FilteredGiftHospitalityView,  GiftHospitalityOfferedView, \
    GiftHospitalityReceivedView, GiftHospitalityReceivedDoneView, GiftHospitalityOfferedDoneView
...
urlpatterns = [
    ...
    path(r'<int:gift_id>/received/', GiftHospitalityReceivedDoneView.as_view(), name='received-done'),
