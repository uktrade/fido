...
class SegmentGrandParent(TimeStampedModel):
    segment_grand_parent_code = models.CharField(max_length=8, primary_key=True, verbose_name='segment grand parent code')
    segment_grand_parent_long_name = models.CharField(max_length=255, verbose_name='segment grand parent long name')
...
class SegmentParent(TimeStampedModel):
    segment_parent_code = models.CharField(max_length=8, primary_key=True,  verbose_name='segment parent code')
...
class EstimateRow(TimeStampedModel):
    estimate_row_code = models.CharField(max_length=8, primary_key=True, verbose_name='estimates row code')
...
class SubSegment(TimeStampedModel):
    ...
    sub_segment_code = models.CharField(max_length=8, primary_key=True, verbose_name='sub segment code')
    ...
    control_budget_detail_code = models.CharField(max_length=50, choices= CONTROL_BUDGET_CHOICES, default=NB, verbose_name='control budget detail code')
    ...
    accounting_authority_DetailCode = models.CharField(max_length=255, choices = CONTROL_ACCOUNTING_AUTH_CHOICES, default=UNDEF, verbose_name='accounting authority detail code')
