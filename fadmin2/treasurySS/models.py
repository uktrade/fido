...
class SubSegment(TimeStampedModel):
    ...
    control_budget_detail_code = models.CharField(max_length=50, choices=CONTROL_BUDGET_CHOICES, default=NB,
    ...
    accounting_authority_DetailCode = models.CharField(max_length=255, choices=CONTROL_ACCOUNTING_AUTH_CHOICES,
                                                       default=UNDEF, verbose_name='accounting authority detail code')
