...
class L5Account(models.Model):
    ...
    estimates_column_code = models.CharField(max_length=25, choices=ESTIMATECODE_CHOICES, default=UNDEF, verbose_name='estimates column code')
    usage_code = models.CharField(max_length=25, choices=USAGECODE_CHOICES, default=BOTH, verbose_name='usage code',blank=True)
