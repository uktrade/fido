    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nac_category_description', models.CharField(max_length=200, verbose_name='Budget Grouping')),
                ('budget_description', models.CharField(max_length=200, verbose_name='Budget Category')),
