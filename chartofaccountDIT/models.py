...
class Analysis2Abstract(models.Model):
    analysis2_code = models.CharField(
        'Market Code',
        primary_key=True,
        max_length=50,
    )
    analysis2_description = models.CharField(
        max_length=300,
        verbose_name='Market',
    )
...
class OperatingDeliveryCategory(
    TimeStampedModel,
    LogChangeModel,
):
    ...
    def __str__(self):
        return str(
            self.operating_delivery_description
        )
