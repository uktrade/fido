...
def test_costcentre_model():
    ...
    directorate_fact = DirectorateFactory(
        directorate_code="D1", directorate_name="Finance", group=group_fact
    )
    costcentre_fact = CostCentreFactory(
        cost_centre_code="Test1", directorate=directorate_fact
    )
