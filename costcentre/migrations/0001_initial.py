# Generated by Django 2.2.10 on 2020-05-22 09:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bsce_email', models.EmailField(max_length=254, unique=True, verbose_name='BSCE email')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director_general', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='costcentre.CostCentrePerson')),
                ('treasury_segment_fk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='treasurySS.Segment', verbose_name='Treasury Segment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='costcentre.CostCentrePerson')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='costcentre.DepartmentalGroup')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_partner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='costcentre.BusinessPartner', verbose_name='Finance Business Partner')),
                ('deputy_director', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='costcentre.CostCentrePerson', verbose_name='Deputy Director')),
                ('directorate', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='costcentre.Directorate')),
            ],
            options={
                'verbose_name': 'Cost Centre',
                'verbose_name_plural': 'Cost Centres',
                'ordering': ['cost_centre_code'],
                'permissions': (('edit_forecast_all_cost_centres', 'Edit all cost centres'), ('assign_edit_for_own_cost_centres', 'Assign edit cost centre for own cost centres')),
